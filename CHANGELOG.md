...
- Mermaid runtime script is now omitted from HTML export when the Markdown contains no Mermaid code blocks.
- Regular image (`img`) rendering width is now normalized to a fixed maximum of 720px for more consistent page layout.
